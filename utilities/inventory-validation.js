...
validate.invRules = () => {
	return [
		...
		body("inv_image")
			...
			.contains("/")
			.withMessage(
				"Inventory image must be a path and contain at least 12 characters."
			),
		...
		body("inv_thumbnail")
			...
			.contains("/")
			.withMessage(
				"Inventory thumbnail must be a path and contain at least 12 characters."
			),
		...
		body("inv_price")
			...
			.isNumeric()
			.withMessage(
				"Inventory price must be a number and at least 3 characters long."
			),
		...
		body("inv_miles")
			...
			.isInt({ min: 0 })
			.withMessage("Inventory miles must be a non-negative integer."),
